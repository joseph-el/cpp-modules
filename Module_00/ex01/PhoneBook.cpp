...
/*   Updated: 2023/04/13 17:48:35 by yoel-idr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PhoneBook::Display(int index, short flag)
{
    if (flag & Display_Contact) {
        std::cout << RED"-----------------[Contact info]-----------------"WHITE << std::endl;
    ...
    for (int i = 0; i < contact_size; i++) 
        std::cout << std::setw(10) << i + 1
                    << std::setw(10) << contact[i].f_name.substr(0, 10)
                    << std::setw(10) << contact[i].l_name.substr(0, 10)
                    << std::setw(10) << contact[i].nickname.substr(0, 10) << std::endl;
}